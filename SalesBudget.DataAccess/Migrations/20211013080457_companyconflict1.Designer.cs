...
namespace SalesBudget.DataAccess.Migrations
{
    ...
    [Migration("20211013080457_companyconflict1")]
    partial class companyconflict1
    {
            ...
            modelBuilder.Entity("SalesBudget.Models.FBudget", b =>
                {
                    ...
                    b.Property<int?>("FBudgetBudgetId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SalesBudget.Models.FBudget", b =>
                {
                    ...
                    b.HasOne("SalesBudget.Models.FBudget", null)
                        .WithMany("FBudgets")
                        .HasForeignKey("FBudgetBudgetId");
